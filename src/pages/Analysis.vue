...
const generateDoc = () => {
  ...
  let avalableStock = [[],['AVAILABLE STOCK:'],
    ...
    analysis.value?.available_stock?.quantity],
  ];
            ...
            <v-card-text>
              ...
              <v-row class="mt-13">
                <v-col
                  ...
                  style="font-weight: 600"
                  cols="3"
                  >AVAILABLE STOCK:</v-col
                >
                <v-col cols="12">
                  <v-row style="font-size: 17px" class="font-weight-medium">
                    <v-col class="text-center" cols="3">{{
                      analysis?.available_stock?.created_at?.split("T")[0]
                    }}</v-col>
                    <v-col class="text-center" cols="3">{{
                      analysis?.available_stock?.quantity
                    }}</v-col>
                    <v-col class="text-center" cols="3"></v-col>
                    <v-col class="text-center" cols="3"></v-col>
                  </v-row>
