...
const editUser = async () => {
    ...
    await putRequestHandler(`/admin/company/${JSON.parse(sessionStorage.getItem(import.meta.env.VITE_SESSION_USER) || '')?.company_id}/customer/${props.userData.id}/deactivate`, Data.value, true)
        .then((res) => {
...
const deactivate = async () => {
    ...
    await putRequestHandler(`/rules/deactivate/${props.userData.id}`, null, true)
        .then((res) => {
