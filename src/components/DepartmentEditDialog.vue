...
onMounted(()=>{
  Data.value = props.departmentData
})
...
const editDepartnment = async () => {
    ...
    await putRequestHandler(`/admin/company/${JSON.parse(sessionStorage.getItem(import.meta.env.VITE_SESSION_USER) || '')?.company_id}/customer/${props.departmentData.id}/deactivate`, Data.value, true)
        .then((res) => {
...
const deactivate = async () => {
    ...
    await putRequestHandler(`/rules/deactivate/${props.departmentData.id}`, null, true)
        .then((res) => {
