        ...
        <v-card max-width="450px" class="mt-n15">
            ...
            <v-card-text>
                <div class="text-center my-3">
                    ...
                    <h4 class="text-h6 text-remOrange py-5">Are you sure you want to delete department "{{deleteData.name}}"?</h4>
...
const deleteUser = async () => {
    ...
    formStore.error = ""
        await deleteRequestHandler(`/department/${props.deleteData.id}`, true)
        .then((res) => {
            formStore.success = "Department Deleted Successfully"
