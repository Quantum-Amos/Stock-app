...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/ErmCode-Analysis': RouteRecordInfo<'/ErmCode-Analysis', '/ErmCode-Analysis', Record<never, never>, Record<never, never>>,
    '/ErmReport': RouteRecordInfo<'/ErmReport', '/ErmReport', Record<never, never>, Record<never, never>>,
