            ...
            <v-card-text>
                <div class="text-center my-3">
                    ...
                    <v-row justify="center" class="mb-3 mt-2">
                        ...
                        <v-col cols="12" md="6">
                            <v-btn @click="deletePaymentTerm" :loading="formStore.loading" block color="secondary"
...
const deletePaymentTerm = async () => {
    ...
    formStore.error = ""
        await deleteRequestHandler(`/payment-terms/${props.deleteData.id}`, true)
        .then((res) => {
            formStore.success = "Payment Term Deleted Successfully"
